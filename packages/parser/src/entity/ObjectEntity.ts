...
import presentationHooks from "../presentation.js"
...
export default class ObjectEntity extends IEntity {
    ...
    nodeColor() {
        return presentationHooks.nodeColor(this)
    }

    nodeIcon() {
        return presentationHooks.nodeIcon(this)
    }

    additionalPinInserter() {
        return presentationHooks.additionalPinInserter(this)
    }
