...
function nodeTemplateClass(nodeEntity) {
  ...
  if (className === p$1.callFunction || className === p$1.commutativeAssociativeBinaryOperator || className === p$1.callArrayFunction) {
    ...
    if (memberName && (memberParent === p$1.kismetArrayLibrary || memberParent === p$1.kismetMathLibrary || memberParent === p$1.kismetStringLibrary || memberParent === p$1.typedElementHandleLibrary)) {
      if (memberName.startsWith("Conv_")) {
